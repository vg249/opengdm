System.register(["@angular/core", "../../model/type-entity", "../../model/type-extractor-filter", "../../model/cv-filter-type", "../../model/filter-params", "../../store/actions/history-action", "@ngrx/store", "../../model/name-id-label-type", "../../model/filter-type", "../../model/file-item-param-names", "rxjs/add/operator/expand", "../../model/type-extractor-item", "../../store/actions/fileitem-action", "../../model/gobii-file-item-compound-id", "./dto-request.service", "../app/jsontogfi/json-to-gfi-dataset", "../app/dto-request-item-gfi", "../app/dto-request-item-gfi-paged", "../../store/actions/action-payload-filter"], function (exports_1, context_1) {
    ...
    return {
        ...
        execute: function () {
            FilterParamsColl = class FilterParamsColl {
                constructor(store, pagedDatasetRequestService, fileItemRequestService) {
                    this.store = store;
                    ...
                    // ************************************************************************
                    // **************************** GENERAL  *********************************
                    let cvJobStatusCompoundUniqueId = new gobii_file_item_compound_id_1.GobiiFileItemCompoundId(type_extractor_item_1.ExtractorItemType.ENTITY, type_entity_1.EntityType.CV, type_entity_1.EntitySubType.UNKNOWN, cv_filter_type_1.CvFilterType.JOB_STATUS, cv_filter_type_1.CvFilters.get(cv_filter_type_1.CvFilterType.JOB_STATUS));
                    // ************************************************************************
                    // **************************** BY SAMPLE *********************************
                    ...
                    this.addFilter(filter_params_1.FilterParams
                        ...
                        let returnVal = null;
                        if (!payloadFilter) {
                            let completedItem = fileItems.find(fi => fi.getItemName() === "completed");
                            let labelItem = fileItems.find(fi => fi.getExtractorItemType() === type_extractor_item_1.ExtractorItemType.LABEL);
                    ...
                    let cvDatasetCompoundUniqueId = new gobii_file_item_compound_id_1.GobiiFileItemCompoundId(type_extractor_item_1.ExtractorItemType.ENTITY, type_entity_1.EntityType.DATASET, type_entity_1.EntitySubType.UNKNOWN, cv_filter_type_1.CvFilterType.UNKNOWN, cv_filter_type_1.CvFilters.get(cv_filter_type_1.CvFilterType.UNKNOWN));
                    this.addFilter(filter_params_1.FilterParams
                    ...
                    let nameIdRequestParamsContactsPi = filter_params_1.FilterParams
                        ...
                        .setIsDynamicFilterValue(true)
                        .setEntitySubType(type_entity_1.EntitySubType.CONTACT_PRINCIPLE_INVESTIGATOR);
                    let nameIdRequestParamsExperiments = filter_params_1.FilterParams
                    ...
                    let nameIdRequestParamsDatasets = filter_params_1.FilterParams
                ...
                addFilter(filterParamsToAdd) {
                    let existingFilterParams = this.filterParams
                        .find(ffp => ffp.getQueryName() === filterParamsToAdd.getQueryName()
                ...
                getFilter(nameIdFilterParamTypes, gobiiExtractFilterType) {
                    return this.filterParams.find(ffp => ffp.getQueryName() === nameIdFilterParamTypes &&
