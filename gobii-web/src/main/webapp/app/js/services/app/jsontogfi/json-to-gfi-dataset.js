System.register(["../../../model/gobii-file-item", "../../../model/type-entity", "../../../model/type-extractor-item", "../../../model/type-process", "../../../model/type-extractor-filter", "../../../model/dataset", "../../../model/gobii-file-item-entity-relation", "../../../model/file-item-param-names"], function (exports_1, context_1) {
    ...
    return {
        ...
        execute: function () {
            JsonToGfiDataset = class JsonToGfiDataset {
                constructor(_filterParams, _filterParamsColl) {
                ...
                convert(jsonItem) {
                    ...
                    let projectRelation = gobii_file_item_entity_relation_1.GobiiFileItemEntityRelation
                    ...
                    let experimentRelation = gobii_file_item_entity_relation_1.GobiiFileItemEntityRelation
                    ...
                    let statusRelation = gobii_file_item_entity_relation_1.GobiiFileItemEntityRelation
