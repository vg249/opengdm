System.register(["@angular/core", "../../model/entity-stats", "../../model/type-entity"], function (exports_1, context_1) {
    ...
    return {
        ...
        execute: function () {
            ...
            DtoRequestItemEntityStats = class DtoRequestItemEntityStats {
                constructor(requestType, entityType, parentEntityType, parentId) {
                ...
                getUrl() {
                    let returnVal;
                    let baseUrl = "gobii/v1/";
                    let entityTypeName = type_entity_1.EntityType[this.entityType];
                    if (this.requestType === EntityRequestType.Count) {
                        ...
                        let parentEntityTypeName = type_entity_1.EntityType[this.parentEntityType];
                        let parentIdAsString = this.parentId.toLocaleString();
                ...
                resultFromJson(json) {
                    let returnVal;
                    let entityStatsFromServer = json.payload.data[0];
