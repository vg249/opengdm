System.register(["@ngrx/store", "ngrx-store-freeze", "./fileitems-reducer", "./treenode-reducer", "./history-reducer"], function (exports_1, context_1) {
    ...
    return {
        ...
        execute: function () {
             ...
             * ```
             */
            exports_1("getFileItemsState", getFileItemsState = (state) => state.fileItems);
            /**
            ...
            exports_1("getGobiiTreeNodesState", getGobiiTreeNodesState = (state) => state.gobiiTreeNodes);
            ...
            exports_1("gobiiHistoryState", gobiiHistoryState = (state) => state.history);
