System.register(["@angular/core", "../model/type-extractor-filter", "../store/actions/fileitem-action", "@ngrx/store", "../services/core/file-item-service", "../services/core/view-id-generator-service", "../services/core/type-control"], function (exports_1, context_1) {
    ...
    return {
        ...
        execute: function () {
            CheckListBoxComponent = class CheckListBoxComponent {
                constructor(store, fileItemService, differs, viewIdGeneratorService) {
                    this.store = store;
                ...
                handleItemChecked(arg) {
                    let currentFileItemUniqueId = arg.currentTarget.value;
                ...
                handleItemSelected(arg) {
                    //        arg.currentTarget.style = "background-color:#b3d9ff";
                }
                handleHeaderStatus(headerStatusMessage) {
