...
export class DatasetDatatableComponent implements OnInit, OnChanges {
    ...
    constructor(private store: Store<fromRoot.State>,
        ...
        if (this.doPaging) {
            this.datasetsFileItems$ = this.store.select(fromRoot.getDatsetEntitiesPaged) as Observable<GobiiFileItem[]>;
        } else {
            this.datasetsFileItems$ = this.store.select(fromRoot.getDatsetEntities) as Observable<GobiiFileItem[]>;
        }
