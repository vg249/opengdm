System.register(["@angular/core", "@angular/forms", "@angular/http", "@angular/platform-browser", "@angular/platform-browser/animations", "../views/export-format.component", "../views/project-list-box.component", "../views/status-display-box.component", "../views/crops-list-box.component", "../views/export-type.component", "../views/dataset-types-list-box.component", "../views/checklist-box.component", "../views/sample-marker-box.component", "ng2-file-upload", "./app.extractorroot", "../services/core/dto-request.service", "../services/core/authentication.service", "../views/text-area.component", "../views/uploader.component", "../views/sample-list-type.component", "primeng/primeng", "../views/status-display-tree.component", "../services/core/file-model-tree-service", "../views/name-id-list-box.component", "../services/core/name-id-service", "./app.component", "../views/login.component", "./app.routing", "@angular/common", "../services/core/auth.guard", "primeng/components/button/button", "./page-by-samples.component", "@ngrx/store", "../store/reducers", "@ngrx/store-devtools", "../environments/environment", "@ngrx/effects", "../store/effects/tree-effects", "../services/core/tree-structure-service", "../store/effects/file-item-effects", "../services/core/file-item-service"], function (exports_1, context_1) {
    "use strict";
