    ...
    return {
        ...
        execute: function () {
            ExtractorRoot = (function () {
                ...
                ExtractorRoot.prototype.handleAddStatusMessage = function (dtoHeaderResponse) {
                    var _this = this;
                    if (dtoHeaderResponse.statusMessages !== null) {
                        dtoHeaderResponse.statusMessages.forEach(function (statusMessage) {
                            _this.messages.push(statusMessage.message);
                        });
                    }
                };
