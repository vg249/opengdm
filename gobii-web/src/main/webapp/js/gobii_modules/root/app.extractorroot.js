            ...
            ExtractorRoot = (function () {
                ...
                ExtractorRoot.prototype.handleExportTypeSelected = function (arg) {
                    ...
                    if (this.gobiiExtractFilterType === type_extractor_filter_1.GobiiExtractFilterType.WHOLE_DATASET) {
                        this.fileItemService.loadNameIdsFromFilterParams(this.gobiiExtractFilterType, file_item_param_names_1.FileItemParamNames.CONTACT_PI, null);
                        this.doPrincipleInvestigatorTreeNotifications = false;
                        this.fileItemService.setItemLabelType(this.gobiiExtractFilterType, file_item_param_names_1.FileItemParamNames.CONTACT_PI, name_id_label_type_1.NameIdLabelType.UNKNOWN);
                        this.displaySelectorPi = true;
                        this.displaySelectorProjectForPi = true;
                        this.displaySelectorForAllProjects = false;
                        this.displaySelectorExperiment = true;
                        ...
                        this.fileItemService.loadNameIdsFromFilterParams(this.gobiiExtractFilterType, file_item_param_names_1.FileItemParamNames.CONTACT_PI, null);
                        this.fileItemService.loadNameIdsFromFilterParams(this.gobiiExtractFilterType, file_item_param_names_1.FileItemParamNames.CV_DATATYPE, null);
                        this.fileItemService.loadNameIdsFromFilterParams(this.gobiiExtractFilterType, file_item_param_names_1.FileItemParamNames.PROJECTS, null);
                        this.displaySelectorPi = true;
                        this.doPrincipleInvestigatorTreeNotifications = true;
                        this.fileItemService.setItemLabelType(this.gobiiExtractFilterType, file_item_param_names_1.FileItemParamNames.CONTACT_PI, name_id_label_type_1.NameIdLabelType.ALL);
                        ...
                        this.fileItemService.loadNameIdsFromFilterParams(this.gobiiExtractFilterType, file_item_param_names_1.FileItemParamNames.CV_DATATYPE, null);
                        this.fileItemService.loadNameIdsFromFilterParams(this.gobiiExtractFilterType, file_item_param_names_1.FileItemParamNames.PLATFORMS, null);
                    ...
                    this.fileItemService.loadNameIdsFromFilterParams(this.gobiiExtractFilterType, file_item_param_names_1.FileItemParamNames.MAPSETS, null);
