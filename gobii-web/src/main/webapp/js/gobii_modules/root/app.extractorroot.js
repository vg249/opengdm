        ...
        execute: function () {
            ExtractorRoot = (function () {
                function ExtractorRoot(_dtoRequestServiceExtractorFile, _dtoRequestServiceNameIds, _dtoRequestServiceContact, _authenticationService, _dtoRequestServiceServerConfigs, _fileModelTreeService, store, fileItemService) {
                    ...
                    this.fileItemsExperiments$ = this.store.select(fromRoot.getExperiments);
                    ...
                    this.fileItemsDatasets = this.store.select(fromRoot.getDatasets);
                    ...
                    this.nameIdRequestParamsExperiments = name_id_request_params_1.NameIdRequestParams
                        .build(type_nameid_filter_params_1.NameIdFilterParamTypes.EXPERIMENTS, type_extractor_filter_1.GobiiExtractFilterType.WHOLE_DATASET, type_entity_1.EntityType.Experiments)
