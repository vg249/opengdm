System.register(["@angular/core", "../../model/type-entity", "../../model/file-model-node", "../../model/type-extractor-filter", "../../model/cv-filter-type", "../../model/type-extract-format", "../../store/reducers", "@ngrx/store", "../../model/name-id", "rxjs/Observable", "../../model/type-extractor-sample-list", "../../model/extractor-instructions/data-set-extract", "../../model/extractor-instructions/gobii-extractor-instruction", "../../model/extractor-instructions/dto-extractor-instruction-files", "../app/dto-request-item-extractor-submission", "../../model/type-gobii-file", "./dto-request.service"], function (exports_1, context_1) {
    ...
    var core_1, type_entity_1, file_model_node_1, type_extractor_filter_1, cv_filter_type_1, type_extract_format_1, fromRoot, store_1, name_id_1, Observable_1, type_extractor_sample_list_1, data_set_extract_1, gobii_extractor_instruction_1, dto_extractor_instruction_files_1, dto_request_item_extractor_submission_1, type_gobii_file_1, dto_request_service_1, InstructionSubmissionService;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
                ...
                InstructionSubmissionService.prototype.submit = function (scope$) {
                    ...
                    this.store.select(fromRoot.getSelectedFileItems)
                        ...
                        if (scope$.gobiiExtractFilterType === type_extractor_filter_1.GobiiExtractFilterType.WHOLE_DATASET) {
                            ...
                            scope$.handleAddMessage("Unhandled extract filter type: " + type_extractor_filter_1.GobiiExtractFilterType[scope$.gobiiExtractFilterType]);
                        }
                    });
