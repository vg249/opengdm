            ...
            JsonToGfiDataset = (function () {
                ...
                JsonToGfiDataset.prototype.convert = function (jsonItem) {
                    ...
                    var projectRelation = gobii_file_item_entity_relation_1.GobiiFileItemEntityRelation
                        .fromGobiiFileItemCompoundId(this._filterParamsColl.getFilter(file_item_param_names_1.FilterParamNames.PROJECT_FILTER_OPTIONAL, type_extractor_filter_1.GobiiExtractFilterType.WHOLE_DATASET))
