System.register(["./type-process", "./guid", "./type-entity", "./cv-filter-type", "./type-extractor-filter", "./type-extractor-item", "./gobii-file-item-compound-id", "./gobii-file-item-entity-relation", "./name-id-label-type"], function (exports_1, context_1) {
    "use strict";
    ...
    var type_process_1, guid_1, type_entity_1, cv_filter_type_1, type_extractor_filter_1, type_extractor_item_1, gobii_file_item_compound_id_1, gobii_file_item_entity_relation_1, name_id_label_type_1, GobiiFileItem;
    return {
        setters: [
        ...
        execute: function () {
            GobiiFileItem = (function (_super) {
                ...
                GobiiFileItem.build = function (gobiiExtractFilterType, processType) {
                    var returnVal = new GobiiFileItem(gobiiExtractFilterType, processType, type_extractor_item_1.ExtractorItemType.UNKNOWN, type_entity_1.EntityType.UNKNOWN, type_entity_1.EntitySubType.UNKNOWN, cv_filter_type_1.CvFilterType.UNKNOWN, null, null, null, null, null, null, [], [], false, 0, false, name_id_label_type_1.NameIdLabelType.UNKNOWN);
                    return returnVal;
                };
