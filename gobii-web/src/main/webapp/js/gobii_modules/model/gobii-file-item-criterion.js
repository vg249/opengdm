        ...
        execute: function () {
            GobiiFileItemCriterion = (function (_super) {
                ...
                function GobiiFileItemCriterion(gobiiFileItemCompoundId, _isPresent) {
                    ...
                    var _this = _super.call(this, gobiiFileItemCompoundId.getExtractorItemType(), gobiiFileItemCompoundId.getEntityType(), gobiiFileItemCompoundId.getEntitySubType(), gobiiFileItemCompoundId.getCvFilterType()) || this;
