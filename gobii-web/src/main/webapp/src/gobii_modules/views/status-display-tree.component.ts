...
export class StatusDisplayTreeComponent implements OnInit, OnChanges {
    ...
    constructor(private store: Store<fromRoot.State>,
        ...
        this.gobiiTreeNodesFromStore$ = store
            .select(fromRoot.getGobiiTreeNodesForExtractFilter) as Observable<GobiiTreeNode[]>;

        this.gobiiSelectedNodesFromStore$ =
          store.select(fromRoot.getSelectedGobiiTreeNodes) as Observable<GobiiTreeNode[]>;
    }
