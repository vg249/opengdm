...
[[_createexperiment]]
=== POST /sample-tracking/v1/experiments
...
|Type|Name|Schema
|**Body**|**body** +
__|<<_experimentdto,ExperimentDTO>>
|===
...
[[_listexperiments]]
=== GET /sample-tracking/v1/experiments
...
[[_getexperimentbyid]]
=== GET /sample-tracking/v1/experiments/{experimentId}
...
[[_creategermplasm]]
=== POST /sample-tracking/v1/germplasm
...
|Type|Name|Schema
|**Body**|**body** +
__|<<_germplasmlistdto,GermplasmListDTO>>
|===
...
[[_listgermplasms]]
=== GET /sample-tracking/v1/germplasm
...
[[_listgermplasms]]
=== GET /sample-tracking/v1/germplasm/{germplasmId}
...
[[_createproject]]
=== POST /sample-tracking/v1/projects
...
[[_listprojects]]
=== GET /sample-tracking/v1/projects
...
[[_getprojectbyid]]
=== GET /sample-tracking/v1/projects/{projectId}
...
[[_createsamples]]
=== POST /sample-tracking/v1/projects/{projectId}/samples
...
__|integer (int32)
|**Body**|**body** +
__|<<_projectsamplesdto,ProjectSamplesDTO>>
|===
