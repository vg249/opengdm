...
public class GOBIIControllerV3Test {
    ...
    public void simpleListTest() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/gobii-dev/gobii/v3/projects").contextPath("/gobii-dev"))
    ...
    public void listWithQueryTest() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/gobii-dev/gobii/v3/projects?page=1&pageSize=100&piContactId=2")
    ...
    public void testCreateSimple() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/gobii-dev/gobii/v3/projects")
    ...
    public void testPatchWithProperties() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.patch("/gobii-dev/gobii/v3/projects/84")
                .contentType(MediaType.APPLICATION_JSON).content(requestJson).contextPath("/gobii-dev")).andDo(print())
    ...
    public void testListProjectProperties() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/gobii-dev/gobii/v3/projects/properties").contextPath("/gobii-dev"))
                .andDo(print()).andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.metadata.pagination.currentPage").value(0))
                .andExpect(jsonPath("$.metadata.pagination.pageSize").value(1))
    ...
    public void testGetProject() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/gobii-dev/gobii/v3/projects/123").contextPath("/gobii-dev"))
                .andDo(print()).andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.metadata").doesNotExist());
    ...
    public void testDelete() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.delete("/gobii-dev/gobii/v3/projects/84").contextPath("/gobii-dev"))
    ...
    public void testGetExperimentsSimple() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/gobii-dev/gobii/v3/experiments").contextPath("/gobii-dev"))
                .andDo(print()).andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.metadata.pagination.currentPage").value(0))
                .andExpect(jsonPath("$.metadata.pagination.pageSize").value(1))
    ...
    public void testGetExperimentById() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/gobii-dev/gobii/v3/experiments/123").contextPath("/gobii-dev"))
                .andDo(print()).andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
    ...
    public void testCreateExperimentsSimple() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/gobii-dev/gobii/v3/experiments")
    ...
    public void testUpdateExperimentSimple() throws Exception {
        ...
        when(experimentService.updateExperiment(eq(123), any(ExperimentDTO.class), eq("test-user")))
                .thenReturn(new ExperimentDTO());
        when(projectService.getDefaultProjectEditor() // TODO: replace this with AuthenticationService
        ).thenReturn("test-user");

        mockMvc.perform(MockMvcRequestBuilders.patch("/gobii-dev/gobii/v3/experiments/123")
                .contentType(MediaType.APPLICATION_JSON).content(jsonRequest).contextPath("/gobii-dev")).andDo(print())
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON));
    ...
    public void testDeleteExperiment() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.delete("/gobii-dev/gobii/v3/experiments/123").contextPath("/gobii-dev"))
