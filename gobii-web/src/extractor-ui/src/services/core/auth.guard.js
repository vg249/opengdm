System.register(["@angular/core", "@angular/router", "keycloak-angular"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, keycloak_angular_1, AuthGuard;
    ...
    return {
        ...
        execute: function () {
            AuthGuard = /** @class */ (function (_super) {
                ...
                AuthGuard = __decorate([
                    ...
                    __metadata("design:paramtypes", [router_1.Router,
                        keycloak_angular_1.KeycloakService])
                ], AuthGuard);
                return AuthGuard;
            }(keycloak_angular_1.KeycloakAuthGuard));
