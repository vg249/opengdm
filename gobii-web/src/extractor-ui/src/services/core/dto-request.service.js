System.register(["@angular/core", "../../model/http-values", "@angular/common/http", "./authentication.service", "../../model/payload/payload-envelope", "rxjs/Observable", "rxjs/add/operator/map", "../../model/payload/header", "../../model/payload/status", "../../model/dto-header-status-message", "rxjs/operators"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, http_values_1, http_1, authentication_service_1, payload_envelope_1, Observable_1, header_1, status_1, dto_header_status_message_1, operators_1, DtoRequestService;
