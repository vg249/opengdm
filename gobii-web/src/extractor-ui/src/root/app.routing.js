System.register(["@angular/router", "./app.extractorroot", "../services/core/auth.guard"], function (exports_1, context_1) {
    "use strict";
    var router_1, app_extractorroot_1, auth_guard_1, appRoutes, routing;
