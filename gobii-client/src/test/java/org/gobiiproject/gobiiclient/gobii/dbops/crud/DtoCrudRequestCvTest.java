...
public class DtoCrudRequestCvTest implements DtoCrudRequestTest {
    ...
    public void get() throws Exception {
        ...
        RestUri restUriCvForGetById = GobiiClientContext.getInstance(null, false)
                .getUriFactory()
                .resourceByUriIdParam(RestRequestId.GOBII_CV);
    ...
    public void testEmptyResult() throws Exception {
        ...
        DtoRestRequestUtils<CvDTO> dtoDtoRestRequestUtils = new DtoRestRequestUtils<>(CvDTO.class, RestRequestId.GOBII_CV);
    ...
    public Integer getGroupIdForASystemOnlyGroup() throws Exception {
        ...
        RestUri restUriCvGroupByType = GobiiClientContext.getInstance(null, false)
                .getUriFactory()
                .resourceByUriIdParam(RestRequestId.GOBII_CVGROUP)
    ...
    public void getList() throws Exception {
        ...
        RestUri restUriCvForGetByGroupName = GobiiClientContext.getInstance(null, false)
                .getUriFactory()
                .resourceByUriIdParamName("groupName", RestRequestId.GOBII_CV);
