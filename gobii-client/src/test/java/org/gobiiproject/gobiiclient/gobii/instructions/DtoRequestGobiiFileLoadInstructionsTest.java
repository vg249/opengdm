...
public class DtoRequestGobiiFileLoadInstructionsTest {
    ...
    public void testSendLoaderInstructionFile() throws Exception {
        ...
        GobiiEnvelopeRestResource<LoaderInstructionFilesDTO> gobiiEnvelopeRestResource = new GobiiEnvelopeRestResource<>(DtoRequestGobiiFileLoadInstructionsTest.gobiiUriFactory.resourceColl(RestResourceId.GOBII_FILE_LOAD_INSTRUCTIONS));
